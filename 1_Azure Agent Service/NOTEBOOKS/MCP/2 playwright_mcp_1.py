...
async def main():
    client = MCPClient()
    messages = [
        SystemMessage(content = "You are a web exploration assistant that can navigate to websites and  help users explore the web by visiting sites and extracting useful information."),
        UserMessage(content = [
            #TextContentItem(text = "Please navigate to https://www.cnn.com and perform the following tasks:\n1. Take a screenshot of the main page\n2. Extract the main heading and purpose of the website\n3. Provide a brief summary of what the website is all about (10-15 sentences)"),
            TextContentItem(text = """
                            Please navigate to https://www.cnn.com and perform the following tasks:
                            1. Take a screenshot of the main page
                            2. Extract the main news in the page.
                            3. list all the main news headlines in the page.
                        """),
